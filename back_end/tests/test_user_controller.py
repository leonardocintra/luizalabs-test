...
class UserControllerTest(TestCase):
    ...
    def test_detail(self):
        """ GET /api/user/<pk> must be return status code 200. """
    ...
    def test_post(self):
        ...
        resp = requests.post(url, self.fb_id)
    ...
    def test_post_required_facebook_id(self):
        ...
        self.assertEqual(428, resp.status_code)

    def test_put(self):
        """ PUT /api/user/<pk> must be return status code 200. """
        url = self.base_url.format("/user/{}".format(self.user.id))
        resp = requests.put(url, self.data)
        self.assertEqual(200, resp.status_code)

    def test_delete(self):
        """ DELETE /api/user/<pk> must be return status code 204 <No Content>.
        """
